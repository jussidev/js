...
/* Para pegar os dados que estão dentro das caixar use a propriedade .VALUE, mas antes determine um evento como referencia para pegar os dados */

/* Adicionei uma escutados para o btnEnviar */
//Uma função anonima pra pegar os valores 
//Calcular o imc

btnEnviar.addEventListener('click', function (e) {
    //pegando os valor dos inputs
